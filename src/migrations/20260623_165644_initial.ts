...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_puppies_status" AS ENUM('available', 'reserved', 'adopted', 'upcoming');
  CREATE TYPE "public"."enum_puppies_sex" AS ENUM('Male', 'Female');
  CREATE TYPE "public"."enum_puppies_size" AS ENUM('Mini', 'Medium', 'Standard');
  CREATE TABLE "puppies_traits" (
  ...
  CREATE TABLE "puppies" (
  	...
  	"status" "enum_puppies_status" DEFAULT 'available' NOT NULL,
  	"sex" "enum_puppies_sex" NOT NULL,
  	"size" "enum_puppies_size" NOT NULL,
  	"color" varchar NOT NULL,
  	"litter" varchar,
  	"birth_date" timestamp(3) with time zone,
  	"ready_date" timestamp(3) with time zone,
  ...
  ALTER TABLE "puppies_traits" ADD CONSTRAINT "puppies_traits_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."puppies"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "puppies" ADD CONSTRAINT "puppies_photo_id_media_id_fk" FOREIGN KEY ("photo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "puppies_traits_order_idx" ON "puppies_traits" USING btree ("_order");
  CREATE INDEX "puppies_traits_parent_id_idx" ON "puppies_traits" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "puppies_slug_idx" ON "puppies" USING btree ("slug");
  CREATE INDEX "puppies_photo_idx" ON "puppies" USING btree ("photo_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "puppies_traits" CASCADE;
  ...
  DROP TYPE "public"."enum_puppies_size";`)
}
